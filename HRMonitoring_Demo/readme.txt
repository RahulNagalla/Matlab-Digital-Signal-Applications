...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Instructions to Use:
1)download datasets from www.zhilinzhang.com/spcup2015/datasets/competition_data.zip
2)extract the downloaded datasets
3)copy the address of the extracted datasets in genpath function in main.m
(line 25): addpath(genpath('..\competition_data'));
4)run main.m 
